...
export const loggers = {
   ...
   * Log GitHub API call
   */
  github: (action: string, metadata?: Record<string, unknown>) => {
   ...
   * Log agent activity
   */
  agent: (agentName: string, action: string, metadata?: Record<string, unknown>) => {
   ...
   */
  issue: (operation: string, issueNumber: number, metadata?: Record<string, unknown>) => {
   ...
   */
  perf: (operation: string, duration: number, metadata?: Record<string, unknown>) => {
